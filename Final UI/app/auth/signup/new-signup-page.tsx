      ...
      <div className="flex w-full max-w-6xl mx-auto rounded-2xl shadow-xl overflow-hidden border">
        ...
        <div className="w-1/2 flex flex-col justify-center bg-white p-12 min-h-full">
          ...
          <form className="space-y-6">
            {userType === 'company' ? (
              ...
              <>
                ...
                <div>
                  ...
                  <Select required>
                    <SelectTrigger className="mt-2 bg-brand-bg-input border-brand-border placeholder-brand-text-light focus:border-brand-blue focus:ring-1 focus:ring-brand-blue py-4 px-4 text-lg font-bold">
            ...
            <div>
              <Label htmlFor="birthdate" className="text-base font-semibold text-brand-text-medium">
              ...
              <div className="relative">
                <Input
                  ...
                  type="date"
                  required
                  className="mt-2 bg-brand-bg-input border-brand-border placeholder-brand-text-light focus:border-brand-blue focus:ring-1 focus:ring-brand-blue py-4 px-4 pr-12 text-lg font-bold"
                  style={{
                    colorScheme: 'light',
